...
////////////////////////////////////////////////////////////////////////////////
///// Instance /////////////////////////////////////////////////////////////////
    DEB #(.WIDTH(1), .INIT(0), .CYCLE_SYNC(2), .CYCLE_HI(2), .CYCLE_LO(2)) u_deb_sig_1 (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Sample(iPulse_1ms), .i(iSIG_1), .o(sig_1_deb));
    DEB #(.WIDTH(1), .INIT(0), .CYCLE_SYNC(2), .CYCLE_HI(2), .CYCLE_LO(2)) u_deb_sig_4 (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Sample(iPulse_1ms), .i(iSIG_4), .o(sig_4_deb));

    assign sig_2_hi = (sig_1_deb);
    assign sig_2_lo = (sig_3_lo);
    assign sig_3_hi = (sig_2);
    assign sig_3_lo = (~(sig_4_deb));
