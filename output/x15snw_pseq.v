...
///// Instance /////////////////////////////////////////////////////////////////
    ...
    assign pvccio_en_hi = (pvnnaon_en_hi & pvnnaon_pg_deb & pch_p0v85a_pg_deb);
    assign pvccio_en_lo = (pvnnaon_en_lo & (~pvnnaon_pg_deb));
    assign pvccio_en_force = 1'b0;  // No Force condition

    assign pvcc1v8_en_hi = (pvccio_en_hi & pvccio_pg_deb & pch_p1v25a_pg_deb);
    assign pvcc1v8_en_lo = (pvccio_en_lo & (~pvccio_pg_deb));
    assign pvcc1v8_en_force = 1'b0;  // No Force condition

    assign rsmrst_n_hi = (pvcc1v8_pg_deb & pch_p3v3a_en & bmc_srst_n_deb);
    ...
    assign pvccdd2_en_hi = (ps_en_hi & ps_pg_deb);
    ...
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(8), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pch_p3v3a_en  (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1us), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pch_p3v3a_en_hi ), .iLo(pch_p3v3a_en_lo ), .iForce(pch_p3v3a_en_force ), .o(pch_p3v3a_en ));
    ...
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(8), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pvcc1v8_en    (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1us), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pvcc1v8_en_hi   ), .iLo(pvcc1v8_en_lo   ), .iForce(pvcc1v8_en_force   ), .o(pvcc1v8_en   ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_rsmrst_n      (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(rsmrst_n_hi     ), .iLo(rsmrst_n_lo     ), .iForce(rsmrst_n_force     ), .o(rsmrst_n     ));
