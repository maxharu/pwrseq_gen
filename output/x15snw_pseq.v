...
///// Instance /////////////////////////////////////////////////////////////////
    ...
    assign rsmrst_n_hi = (prim_vr_en_deb & pch_p0v85a_pg_deb & pvnnaon_pg_deb & pch_p1v25a_pg_deb & pvccio_pg_deb & pch_p1v8a_pg_deb & pvcc1v8_pg_deb & pch_p3v3a_pg_deb);
    assign rsmrst_n_lo = 1'b0;  // No Lo condition (F-DEP-06)
    ...
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(5), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pch_p0v85a_en (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_2ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pch_p0v85a_en_hi), .iLo(pch_p0v85a_en_lo), .iForce(pch_p0v85a_en_force), .o(pch_p0v85a_en));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pch_p1v25a_en (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pch_p1v25a_en_hi), .iLo(pch_p1v25a_en_lo), .iForce(pch_p1v25a_en_force), .o(pch_p1v25a_en));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pch_p1v8a_en  (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pch_p1v8a_en_hi ), .iLo(pch_p1v8a_en_lo ), .iForce(pch_p1v8a_en_force ), .o(pch_p1v8a_en ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pch_p3v3a_en  (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pch_p3v3a_en_hi ), .iLo(pch_p3v3a_en_lo ), .iForce(pch_p3v3a_en_force ), .o(pch_p3v3a_en ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pvnnaon_en    (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pvnnaon_en_hi   ), .iLo(pvnnaon_en_lo   ), .iForce(pvnnaon_en_force   ), .o(pvnnaon_en   ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pvccio_en     (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pvccio_en_hi    ), .iLo(pvccio_en_lo    ), .iForce(pvccio_en_force    ), .o(pvccio_en    ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pvcc1v8_en    (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pvcc1v8_en_hi   ), .iLo(pvcc1v8_en_lo   ), .iForce(pvcc1v8_en_force   ), .o(pvcc1v8_en   ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(3), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_rsmrst_n      (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(rsmrst_n_hi     ), .iLo(rsmrst_n_lo     ), .iForce(rsmrst_n_force     ), .o(rsmrst_n     ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(4), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_psu_en        (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_32ms), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(psu_en_hi       ), .iLo(psu_en_lo       ), .iForce(psu_en_force       ), .o(psu_en       ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pvccdd2_en    (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pvccdd2_en_hi   ), .iLo(pvccdd2_en_lo   ), .iForce(pvccdd2_en_force   ), .o(pvccdd2_en   ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(2), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_imvp_vr_en    (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(imvp_vr_en_hi   ), .iLo(imvp_vr_en_lo   ), .iForce(imvp_vr_en_force   ), .o(imvp_vr_en   ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(3), .CYCLE_LO(4), .CYCLE_FORCE(2), .OD(0)) u_pch_pwrok     (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1ms ), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(pch_pwrok_hi    ), .iLo(pch_pwrok_lo    ), .iForce(pch_pwrok_force    ), .o(pch_pwrok    ));
///// Always Block /////////////////////////////////////////////////////////////
    // None
