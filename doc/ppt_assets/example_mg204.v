...
//   Auto-generated.                                                          //
////////////////////////////////////////////////////////////////////////////////
`ifndef EXAMPLE_MG204_V
`define EXAMPLE_MG204_V
...
wire p5v_en_hi     , p5v_en_lo     , p5v_en_force     ;
wire p3v3_en_hi    , p3v3_en_lo    , p3v3_en_force    ;
wire p1v8_en_hi    , p1v8_en_lo    , p1v8_en_force    ;
wire p1v1_hub_en_hi, p1v1_hub_en_lo, p1v1_hub_en_force;
...
///// Instance /////////////////////////////////////////////////////////////////
    ...
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(8), .CYCLE_LO(4), .CYCLE_FORCE(2), .RECOVER(2'b11), .FORCE(0), .CYCLE_SYNC(0), .OD(0)) u_p5v_en      (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1us), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(p5v_en_hi     ), .iLo(p5v_en_lo     ), .iForce(p5v_en_force     ), .o(p5v_en     ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(8), .CYCLE_LO(4), .CYCLE_FORCE(2), .RECOVER(2'b11), .FORCE(0), .CYCLE_SYNC(0), .OD(0)) u_p3v3_en     (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1us), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(p3v3_en_hi    ), .iLo(p3v3_en_lo    ), .iForce(p3v3_en_force    ), .o(p3v3_en    ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(8), .CYCLE_LO(4), .CYCLE_FORCE(2), .RECOVER(2'b11), .FORCE(0), .CYCLE_SYNC(0), .OD(0)) u_p1v8_en     (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1us), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(p1v8_en_hi    ), .iLo(p1v8_en_lo    ), .iForce(p1v8_en_force    ), .o(p1v8_en    ));
    PSEQCELL #(.INIT(0), .WIDTH(1), .CYCLE_HI(8), .CYCLE_LO(4), .CYCLE_FORCE(2), .RECOVER(2'b11), .FORCE(0), .CYCLE_SYNC(0), .OD(0)) u_p1v1_hub_en (.iRst(iRst), .iClk_Core(iClk_Core), .iPulse_Hi(iPulse_1us), .iPulse_Lo(iPulse_1us), .iPulse_Force(iPulse_1us), .iHi(p1v1_hub_en_hi), .iLo(p1v1_hub_en_lo), .iForce(p1v1_hub_en_force), .o(p1v1_hub_en));
///// Always Block /////////////////////////////////////////////////////////////
    // None
...
endmodule //example_mg204
`endif  //EXAMPLE_MG204_V